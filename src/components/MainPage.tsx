  ...
  return (
    <div>
      <div className='w-full h-screen'>
        <div id='nbar' className='flex flex-col justify-around bg-gray-100 w-full h-40 py-4 fixed'>
        ...
        <div id='main' className='flex flex-row w-full h-full'>
            <div id='fnav' className='w-full h-full max-w-32 bg-green-100'></div>

            <div id='content' className='flex flex-col gap-4 ml-10 w-full mt-44'>
